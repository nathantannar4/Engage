...
open class LocationPickerViewController: UIViewController {
    ...
    /// default: .Minimal
    open var searchBarStyle: UISearchBarStyle = .default
	...
	open override func viewDidLoad() {
        ...
        // dismiss view
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Cancel", style: .plain, target: self, action: #selector(dismissView))
...
extension LocationPickerViewController: MKMapViewDelegate {
	...
	public func mapView(_ mapView: MKMapView, annotationView view: MKAnnotationView, calloutAccessoryControlTapped control: UIControl) {
        ...
        if address != "" {
            Event.sharedInstance.location = address + ", " + city
        } else {
            Event.sharedInstance.location = title!
        }
        Event.sharedInstance.long = view.annotation?.coordinate.longitude
        Event.sharedInstance.lat = view.annotation?.coordinate.latitude
